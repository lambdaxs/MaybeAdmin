    ...
    "routes": [
      ...
      },
      {
        ...
        "routes": [
          ...
          {
            "component": () => React.createElement(require('/Users/xiaos/WebstormProjects/antd-dev/node_modules/_umi-build-dev@1.0.3@umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/page', hasRoutesInConfig: true })
          }
        ]
      },
      {
